 ...
 */
public class HBase13HTableDescriptorBuilder extends HTableDescriptorBuilder {
  HBase13HTableDescriptorBuilder(TableName tableName) {
    super(tableName);
  }

  HBase13HTableDescriptorBuilder(HTableDescriptor descriptorToCopy) {
