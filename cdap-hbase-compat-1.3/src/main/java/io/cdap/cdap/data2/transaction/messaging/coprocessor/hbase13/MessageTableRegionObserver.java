...
package io.cdap.cdap.data2.transaction.messaging.coprocessor.hbase13;
...
import io.cdap.cdap.data2.util.hbase.HBase13ScanBuilder;
  ...
  public void start(CoprocessorEnvironment e) throws IOException {
    if (e instanceof RegionCoprocessorEnvironment) {
      ...
      topicMetadataCacheSupplier = new TopicMetadataCacheSupplier(
        env, cConfReader, tablePrefix, metadataTableNamespace, new HBase13ScanBuilder());
