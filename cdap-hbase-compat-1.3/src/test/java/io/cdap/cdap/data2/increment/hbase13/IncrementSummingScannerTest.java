...
package io.cdap.cdap.data2.increment.hbase13;

import com.google.common.collect.Lists;
import io.cdap.cdap.common.conf.CConfiguration;
import io.cdap.cdap.data.hbase.HBase13Test;
...
public class IncrementSummingScannerTest {
  ...
  @ClassRule
  public static final HBase13Test TEST_HBASE = new HBase13Test();
  ...
  static HRegion createRegion(Configuration hConf, CConfiguration cConf, TableId tableId,
    ...
    WAL hLog = walFactory.getWAL(new byte[]{1}, new byte[]{1});
