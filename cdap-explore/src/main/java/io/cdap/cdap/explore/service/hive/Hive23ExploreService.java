 ...
 */
public class Hive23ExploreService extends BaseHiveExploreService {
  ...
  @Inject
  public Hive23ExploreService(TransactionSystemClient txClient, DatasetFramework datasetFramework,
