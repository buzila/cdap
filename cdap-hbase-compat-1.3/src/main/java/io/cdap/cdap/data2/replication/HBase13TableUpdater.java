 ...
 */
public class HBase13TableUpdater extends TableUpdater {
  private static final Logger LOG = LoggerFactory.getLogger(HBase13TableUpdater.class);
  private final HTableInterface hTableInterface;

  public HBase13TableUpdater(String rowType, Configuration conf, HTableInterface hTableInterface) {
    super(rowType, conf);
